...
export default function LoadingSkeleton() {
  return (
    <Card className="relative px-2 h-[700px] w-[600px] max-w-lg mx-auto overflow-hidden bg-linear-to-br from-background/80 via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
            ...
            {[1, 2].map((_, index) => (
              ...
              >
                <div className="flex relative items-start gap-3">
                  <Skeleton className="h-6 w-6 rounded-full bg-rose-500/10" />
                  <div className="flex-1">
                    <Skeleton className="h-6 w-full bg-rose-500/10" />
                  </div>
                </div>
